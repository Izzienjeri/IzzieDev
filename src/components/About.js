    ...
    <>
      ...
      <Box className={classes.aboutContainer}>
        ...
        <Typography variant="body2" className={classes.aboutText}>
          In web development, I excel in Flask, Next.js, React, TypeScript, Tailwind CSS,Materi and Admin LTE, crafting captivating frontend experiences and robust backend systems with seamless REST API integrations.
        </Typography>
        <Typography variant="body2" className={classes.aboutText}>
